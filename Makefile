...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/18 16:59:52 by ediego            #+#    #+#              #
#    Updated: 2019/09/18 17:32:10 by ediego           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME=libft.a

SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c ft_isspace.c \
	ft_isalpha.c ft_isascii.c ft_isdigit.c ft_islower.c ft_isprint.c \
	ft_isupper.c ft_itoa.c ft_lstadd.c ft_lstsize.c \
	...
	ft_strcpy.c ft_strdel.c ft_strrev.c \
...
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isspace.o\
		ft_isalpha.o ft_isascii.o ft_isdigit.o ft_islower.o ft_isprint.o \
		ft_isupper.o ft_itoa.o ft_lstadd.o ft_lstsize.o \
		...
		ft_strcpy.o ft_strdel.o ft_strrev.o \
